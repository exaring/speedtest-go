...
function Speedtest() {
  this._selectedServer = {}; //when using multiple points of test, this is the selected server
  this._settings = {}; //settings for the speedtest worker
  this._state = 0; //0=adding settings, 1=adding servers, 2=server selection done, 3=test running, 4=done
  console.log(
    "Based on LibreSpeed by Federico Dossena v5.2.4 - https://github.com/librespeed/speedtest"
  );
  console.log(
      "Frontend adapted for waipu.tv - https://github.com/exaring/speedtest"
  );
}
